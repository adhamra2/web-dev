...
ScrollReveal().reveal(".c1", {duration: 2000} ,  );
ScrollReveal().reveal(".c2", {duration: 2500} ,  );
ScrollReveal().reveal(".c3", {duration: 3000} ,  );
ScrollReveal().reveal(".c4", {duration: 3100} ,  );
ScrollReveal().reveal(".line", {duration: 2000} ,  );
ScrollReveal().reveal(".project-header", {duration: 2000} ,  );